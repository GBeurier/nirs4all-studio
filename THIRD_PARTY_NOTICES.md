...
The native product runtime embeds `nirs4all-methods` 1.0.16 from commit
`49aa40e90afef676f25809db1bd2a523e9582a49` (tree
`03de9a3f0b116b4d4c7446acc6cd1e4bf8814a83`) as `libn4m`, under CeCILL-2.1.
