...
from .library_aggregated_steps import (
    _chain_step_to_canonical as _chain_step_to_canonical,
)
from .library_aggregated_steps import (
    _clean_expanded_pipeline_step as _clean_expanded_pipeline_step,
)
from .library_aggregated_steps import (
    _extract_expanded_pipeline_steps as _extract_expanded_pipeline_steps,
)
from .library_aggregated_steps import (
    _extract_stored_pipeline_steps as _extract_stored_pipeline_steps,
)
from .library_aggregated_steps import (
    _is_runtime_only_step_repr as _is_runtime_only_step_repr,
)
from .library_aggregated_steps import (
    _looks_like_canonical_chain_payload as _looks_like_canonical_chain_payload,
)
from .library_aggregated_steps import (
    _normalize_chain_payload as _normalize_chain_payload,
)
from .library_aggregated_steps import (
    _normalize_chain_reference as _normalize_chain_reference,
)
...
async def get_prediction_arrays(prediction_id: str):
    ...
    try:
        ...
        n_samples = 0
        for value in (y_true, y_pred, sample_indices, sample_ids, weights, y_proba, sample_metadata):
