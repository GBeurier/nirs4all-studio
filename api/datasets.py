...
async def get_synthetic_presets() -> dict[str, list[SyntheticPresetInfo]]:
    ...
    document = json.loads((Path(__file__).parent / "synthetic_datasets.json").read_text(encoding="utf-8"))
    return {"presets": [SyntheticPresetInfo(**preset) for preset in document["presets"]]}
