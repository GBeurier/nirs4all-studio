...
grep -q '"selected_release_commit": "b08c62638829e0bcab741e66d44a3db66459e5a8"' "$vendor_root/PROVENANCE.json"
grep -q '"selected_release_repository_tree": "5b5be85d2326fcb360e05ac65572faa18c3a322d"' "$vendor_root/PROVENANCE.json"
