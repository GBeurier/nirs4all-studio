...
use super::assemble::{AssembledDataset, FoldProvenance, IdentityProvenance, PartitionBlock};
...
pub struct PackagePartition {
    ...
    pub n_samples: usize,
    /// Feature-source ids aligned with feature-matrix payload order.
...
pub struct DatasetPackage {
    ...
    /// Scientific identity retained for lossless in-memory round trips.
    ...
    pub folds: Vec<Fold>,
    /// Stable fold identities retained for lossless in-memory round trips.
