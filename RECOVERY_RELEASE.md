...
This patch continues the Python backend and explicit legacy execution engine from Studio 0.11.8, with the corrected nirs4all 1.1.3 library. Existing schema-5 workspaces remain supported.
...
- The bundled Python runtime is pinned to the published `nirs4all 1.1.3`, `dag-ml 0.3.26`, `dag-ml-data 0.2.11`, `nirs4all-methods 1.0.21`, and `nirs4all-io 0.2.0` ecosystem.
