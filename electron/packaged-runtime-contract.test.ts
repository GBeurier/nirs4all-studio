...
function makeResources(): {
  ...
  fs.writeFileSync(markerPath, JSON.stringify({
    ...
    wheel_sha256: "d8af69437ecac1c814ec6d5ce22e8e8d5de758e0ebd1ac5131ae3383cd1e3fd0",
    distribution: "nirs4all",
    distribution_version: "1.1.5",
    installed_manifest_sha256: "6d945c597c4c7c3f927acfc4e0b298577afec85c4dba64cc0f20d5af4a6022ce",
    conversion_tools: {
