# Licensing — nirs4all-studio

`nirs4all-studio` is part of the **nirs4all ecosystem** and is offered under a
...
for example, embedding `nirs4all-studio` in a **proprietary, closed-source product or SaaS**
...
`nirs4all-studio` relies on third-party open-source components. Their licenses are summarized
